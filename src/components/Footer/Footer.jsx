...
import MailchimpFormContainer from "../NewsLetter/NewsLetter";
      ...
      <Box className="bg-[#9d6932] xsm:px-[4%] px-[5%] pt-[6%] pb-[2%]">
        <Box className="grid mxl:grid-cols-4 md:grid-cols-3 xsm:grid-cols-2 grid-cols-1 gap-[40px]">
          <Stack spacing={7} className="w-[100%]">
            ...
            <Text className="text-[16px] font-Poppins font-[300] text-[white]">
            Your support helps us provide essential resources, empower communities, and create lasting impact across Nigeria. Together, we can bring hope and build a brighter future for those in need.
            </Text>
            <Box className="flex items-center gap-[20px]">
              ...
              <Link>
                <BsTwitterX size="22px" color="white" />
              </Link>
            </Box>
          </Stack>
          <Stack spacing={7}>
            <Text className="text-[20px] text-[white] font-Poppins font-[700]">
              Navigation
            </Text>
            <Stack spacing={4}>
              <Link className="xsl:w-[50%] w-[60%]" to="/">
                <Text className="text-[16px] font-Poppins font-[300] text-[white]">
                  Home
                </Text>
              </Link>
              <Link className="xsl:w-[50%] w-[60%]" to="/about">
                <Text className="text-[16px] font-Poppins font-[300] text-[white]">
                  About Us
                </Text>
              </Link>
              <Link className="xsl:w-[50%] w-[60%]" to="/news">
                <Text className="text-[16px] font-Poppins font-[300] text-[white]">
                  News
                </Text>
              </Link>
              <Link className="xsl:w-[50%] w-[60%]" to="/getinvolved">
                <Text className="text-[16px] font-Poppins font-[300] text-[white]">
                  Get Involved
                </Text>
              </Link>
              <Link className="xsl:w-[80%] w-[80%]" to="/programs">
                <Text className="text-[16px] font-Poppins font-[300] text-[white]">
                  Programs/Projects
                </Text>
              </Link>
          ...
          <Stack spacing={7} className="w-[100%]">
            ...
            <Stack spacing={4}>
              ...
              <Button
                text="SUBMIT"
                icon={FaArrowRight}
                className="bg-customorange text-[white] px-[30px] flex gap-[10px] items-center justify-center font-Poppins text-[16px] font-[700] h-[50px] py-[10px] rounded-[50px]"
              /> */}
