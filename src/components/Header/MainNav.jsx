...
const MainNav = () => {
  ...
  return (
    ...
    <div className="relative">
      <div className={`gen-cont bg-white shadow-md flex items-center justify-between py-[10px] xsm:px-[50px] px-[15px]  ${isFixed? 'fixed z-[999] w-[100%] top-0 animate-slideDown' : 'relative'}`} id="header" position={isFixed ? 'fixed' : 'relative'}>
        ...
        <div className="nav-links font-Poppins hidden mxl:flex">
          <ul className="flex items-center gap-[35px]">
            <Link to="/about">
              <li className="hover:text-customorange cursor-pointer">About Us</li>
            </Link>
            <Link to="/news">
      ...
      <div className="mobile-menu relative">
        <div className={`mxl:hidden transition-all duration-300 ease-in-out ${isOpen ? 'flex flex-col list-none gap-[16px] z-[-100] slide-down opacity-100 font-Poppins bg-[white] px-[20px] py-[10px] text-[12px] xsm:text-[15px]' : 'hidden' } `}>
          <Link to="/about" className="xsl:w-[20%] w-[30%]">
            ...
            <Link to="/news" className="xsl:w-[20%] w-[30%]">
              <li className="hover:text-customorange">News</li>
            </Link>
            <Link to="/getinvolved" className="xsl:w-[30%] w-[40%]">
              <li className="hover:text-customorange">Get Involved</li>
            </Link>
            <Link to="/programs" className="xsl:w-[20%] w-[30%]">
              <li className="hover:text-customorange">Programs/Projects</li>
            </Link>
            <Button
              text="Donate Now"
