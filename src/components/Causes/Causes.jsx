...
<h2></h2>
  ...
  return (
    <>
    <h2 className="md:text-[40px] sm:text-[35px] text-[25px] text-center font-[700] my-[30px]">Causes we are serving</h2>
                ...
                <CardBody>
                  <Stack mt="3" pr="1" pl="1" spacing="3">
                    ...
                    <Box className="flex items-center gap-[25px]">
                        <Button text="Donate" className="px-[30px] py-[10px] text-white rounded-[20px]"/>
